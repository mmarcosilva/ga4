...
explore: events_20221108 {
  hidden: yes
    join: events_20221108__items {
      view_label: "Events 20221108: Items"
      sql: LEFT JOIN UNNEST(${events_20221108.items}) as events_20221108__items ;;
      relationship: one_to_many
    }
    join: events_20221108__event_params {
      view_label: "Events 20221108: Event Params"
      sql: LEFT JOIN UNNEST(${events_20221108.event_params}) as events_20221108__event_params ;;
      relationship: one_to_many
    }
    join: events_20221108__user_properties {
      view_label: "Events 20221108: User Properties"
      sql: LEFT JOIN UNNEST(${events_20221108.user_properties}) as events_20221108__user_properties ;;
      relationship: one_to_many
    }
}
view: events_20221108 {
  sql_table_name: `bq-test-283619.analytics_167672070.events_20221108` ;;
...
view: events_20221108__items {
  ...
  dimension: events_20221108__items {
    type: string
    hidden: yes
    sql: events_20221108__items ;;
  }
...
view: events_20221108__event_params {

  dimension: events_20221108__event_params {
    type: string
    hidden: yes
    sql: events_20221108__event_params ;;
  }
  dimension: key {
    type: string
    sql: key ;;
...
view: events_20221108__user_properties {

  dimension: events_20221108__user_properties {
    type: string
    hidden: yes
    sql: events_20221108__user_properties ;;
  }
  dimension: key {
    type: string
    sql: key ;;
