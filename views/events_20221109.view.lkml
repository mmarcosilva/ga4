...
explore: events_20221109 {
  hidden: yes
    join: events_20221109__items {
      view_label: "Events 20221109: Items"
      sql: LEFT JOIN UNNEST(${events_20221109.items}) as events_20221109__items ;;
      relationship: one_to_many
    }
    join: events_20221109__event_params {
      view_label: "Events 20221109: Event Params"
      sql: LEFT JOIN UNNEST(${events_20221109.event_params}) as events_20221109__event_params ;;
      relationship: one_to_many
    }
    join: events_20221109__user_properties {
      view_label: "Events 20221109: User Properties"
      sql: LEFT JOIN UNNEST(${events_20221109.user_properties}) as events_20221109__user_properties ;;
      relationship: one_to_many
    }
}
view: events_20221109 {
  sql_table_name: `bq-test-283619.analytics_167672070.events_20221109` ;;
...
view: events_20221109__items {
  ...
  dimension: events_20221109__items {
    type: string
    hidden: yes
    sql: events_20221109__items ;;
  }
...
view: events_20221109__event_params {

  dimension: events_20221109__event_params {
    type: string
    hidden: yes
    sql: events_20221109__event_params ;;
  }
  dimension: key {
    type: string
    sql: key ;;
...
view: events_20221109__user_properties {

  dimension: events_20221109__user_properties {
    type: string
    hidden: yes
    sql: events_20221109__user_properties ;;
  }
  dimension: key {
    type: string
    sql: key ;;
